...
<body>
    ...
    <nav style="z-index: 1000" class="navbar navbar-expand-lg navbar-light color-navegacion shadow">
      <div class="logo">
          <!-- Titulo de la página -->
          <h1 class="text-center text-white"><a href="{{ route('principal') }}" class="nav-link">Biblioteca Escolar</a></h1>
      </div>
        <div class="container-fluid d-flex justify-content-end">
          ...
          <div class="collapse navbar-collapse mt-2" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link text-white p-3 enlace" aria-current="page" href="{{ route('libros.create') }}">Libros</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-white p-3 enlace" aria-current="page" href="{{ route('administrador.index') }}">Administradores</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-white p-3 enlace" aria-current="page" href="{{ route('alumno.index') }}">Alumnos</a>
              </li>
                ...
                <ul class="navbar-nav">
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu">
                      {{-- <li><a class="dropdown-item" href="{{ route('uni1') }}">UNIVERSIDAD 1</a></li> --}}
                    </ul>
                  </li>
                </ul>
              </div>
